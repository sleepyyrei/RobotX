...
class Mission:
    ...
    class Pose():
        ...
        '''
        def __init__(self,enu_x = -1, enu_y = -1, heading = -1):
    ...
    class Waypoint:
        ...
        '''
        def __init__(self, wp_mode = "NONE", enu_x = -1, enu_y = -1, heading = 0):
            self.wp_mode = wp_mode
            self.pose = Mission.Pose(enu_x, enu_y, heading)
    ...
    class Path:
        ...
        def __init__(self, waypoints = []):
            ...
            wps = waypoints
            for wp in wps:
                self.wps.append(Mission.Waypoint(wp_mode = wp.wp_mode, enu_x = wp.pose.enu_x, enu_y= wp.pose.enu_y, heading = wp['heading']))
