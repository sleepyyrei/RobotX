...
def gps_to_enu(lat, lon, alt, baseLat, baseLon):
    ...
    lat0 = baseLat # degree North
    lon0 = baseLon # degree East
    alt0 = 0 # meters
    enu = pymap3d.geodetic2enu(lat, lon, 0, lat0, lon0, alt0)
    x = enu[0]
    y = enu[1]
    z = enu[2]
    return x, y, z

def enu_to_gps(x, y, z, baseLat, baseLon):
    '''
    ...
    lon0 = baseLon # degree East
    alt0 = 0 # meters
    gps = pymap3d.enu2geodetic(x, y, 0, lat0, lon0, alt0)
    lat = gps[0]
    lon = gps[1]
    alt = gps[2]
    return lat, lon, alt
